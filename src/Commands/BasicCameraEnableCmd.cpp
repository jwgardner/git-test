...
BasicCameraEnableCmd::BasicCameraEnableCmd(
...
void BasicCameraEnableCmd::Execute() { m_camera->Enable(); }

// ==========================================================================
// Make this return true when this Command no longer needs to run Execute.

bool BasicCameraEnableCmd::IsFinished() { return true; }
...
void BasicCameraEnableCmd::Interrupted() { End(); }
