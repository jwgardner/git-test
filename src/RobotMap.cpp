...
void RobotMap::init() {
  ...
  driveTrainFrontLeftDrive->SetFeedbackDevice(
  ...
  driveTrainFrontLeftSteer->SetFeedbackDevice(
      CANTalon::CtreMagEncoder_Absolute);
  driveTrainFrontLeftPos =
      new AnalogChannelVolt(FLP, true, RATIO, driveTrainFrontLeftSteer);
  ...
  driveTrainFrontRightDrive->SetFeedbackDevice(
      CANTalon::CtreMagEncoder_Relative);
  ...
  driveTrainFrontRightSteer->SetFeedbackDevice(
      CANTalon::CtreMagEncoder_Absolute);
  driveTrainFrontRightPos =
      new AnalogChannelVolt(FRP, true, RATIO, driveTrainFrontRightSteer);
  ...
  driveTrainRearLeftPos =
      new AnalogChannelVolt(RLP, true, RATIO, driveTrainRearLeftSteer);
  ...
  driveTrainRearRightDrive->SetFeedbackDevice(
      CANTalon::CtreMagEncoder_Relative);
  ...
  driveTrainRearRightSteer->SetFeedbackDevice(
      CANTalon::CtreMagEncoder_Absolute);
  driveTrainRearRightPos =
      new AnalogChannelVolt(RRP, true, RATIO, driveTrainRearRightSteer);
